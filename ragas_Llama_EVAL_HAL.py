...
GROUND_RAG_TRUTH_FILE = "./rag_hallucinate.json"
...
#     print("\nNo existing ground truth found.")
#     print("\nOptions:")
#     print("1. Auto-generate questions using LLM (quick but may need review)")
#     print("2. Create manual template (more accurate)")
    
#     choice = input("\nChoose (1/2) or 'skip' to skip evaluation: ").strip()
    
#     if choice == "1":
#         ground_truth = generate_ground_truth_questions(llm, valid_docs, num_questions=3)
#         if ground_truth:
#             save_ground_truth(ground_truth, GROUND_TRUTH_FILE)
#             print("\nREVIEW ground_truth.json and edit if needed!")
#             print("Then run this script again.")
#             logger.close()
#             exit()
#         else:
#             print("\nFailed to generate ground truth. Creating manual template instead.")
#             template = create_manual_ground_truth_template()
#             save_ground_truth(template, GROUND_TRUTH_FILE)
#             print(f"\n✓ Template created at {GROUND_TRUTH_FILE}")
#             print("Please edit this file with your questions and answers.")
#             print("Then run this script again.")
#             logger.close()
#             exit()
#     elif choice == "2":
...
#         exit()
#     else:
#         print("\nSkipping evaluation. Run script again when ready.")
#         logger.close()
#         exit()
